        ...
        const material = new THREE.ShaderMaterial({
          ...
          fragmentShader: `
            ...
            void main() {
              ...
              texCoords.y += mix(0.0, circle * noise * 0.01, invertedMouseEnter);

              // Apply swirl when NOT hovering
              float swirlFactor = circle * invertedMouseEnter * 0.02;
...
export default ReverseImageShader;
